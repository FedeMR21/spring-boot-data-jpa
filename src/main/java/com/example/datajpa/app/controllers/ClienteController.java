...
import com.example.datajpa.app.models.service.IUploadFileService;
import com.example.datajpa.app.util.paginator.PageRender;
...
public class ClienteController {
    ...
    public String listar(@RequestParam(name = "page", defaultValue = "0") int page, Model model,
        ...
        if (securityContext.isUserInRole("ADMIN")) {
            logger.info("Forma usandp SecurityContextHolderAwareRequestWrapper: Hola ".concat(auth.getName()).concat(" tienes acceso!"));
        } else {
            logger.info("Forma usando SecurityContextHolderAwareRequestWrapper Hola ".concat(auth.getName()).concat(" NO tienes acceso!"));
        }

        if (request.isUserInRole("ROLE_ADMIN")) {
            logger.info("Forma usandp HttpServletRequest: Hola ".concat(auth.getName()).concat(" tienes acceso!"));
        } else {
